	tilepal 0, GRAY, GREEN, GREEN, RED, BROWN, ROOF, ROOF, ROOF
	tilepal 0, ROOF, ROOF, YELLOW, YELLOW, YELLOW, GREEN, GREEN, GRAY
	tilepal 0, GRAY, GREEN, ROOF, GREEN, WATER, ROOF, ROOF, ROOF
	tilepal 0, ROOF, ROOF, GRAY, BROWN, BROWN, GRAY, GREEN, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GRAY, GREEN, ROOF, ROOF, GREEN
	...
	tilepal 0, GREEN, GREEN, GRAY, BROWN, GRAY, GRAY, GRAY, RED
	tilepal 0, GREEN, GREEN, GREEN, ROOF, GREEN, GREEN, GREEN, GREEN
	tilepal 0, GREEN, GREEN, GRAY, BROWN, GRAY, GRAY, GRAY, GRAY
