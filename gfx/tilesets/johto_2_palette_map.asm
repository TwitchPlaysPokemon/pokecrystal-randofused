	...
	tilepal 0, GRAY, GRAY, BROWN, RED, RED, GRAY, YELLOW, GREEN
	...
	tilepal 0, RED, BROWN, GRAY, GRAY, BROWN, BROWN, BROWN, GREEN
	tilepal 0, GREEN, WATER, GRAY, GREEN, GREEN, GREEN, GRAY, GRAY
