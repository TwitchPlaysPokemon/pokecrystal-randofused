...
; ???
	...
	const EVENT_10E
; Guide Gent events
	const EVENT_NEED_BASEMENT_KEY
	const EVENT_NEED_BICYCLE
	const EVENT_NEED_CARD_KEY
	const EVENT_NEED_COIN_CASE
	const EVENT_NEED_GOOD_ROD
	const EVENT_NEED_ITEM_FINDER
	const EVENT_NEED_MACHINE_PART
	const EVENT_NEED_OLD_ROD
	const EVENT_NEED_RAIL_PASS
	const EVENT_NEED_RED_SCALE
	const EVENT_NEED_SECRETPOTION
	const EVENT_NEED_SILVER_WING
	const EVENT_NEED_SQUIRTBOTTLE
	const EVENT_NEED_SS_TICKET
	const EVENT_NEED_SUPER_ROD
	const EVENT_NEED_BLUE_CARD
	const EVENT_NEED_CLEAR_BELL
	const EVENT_NEED_MASTER_BALL
	const EVENT_NEED_EXP_SHARE
	const EVENT_NEED_CUT
	const EVENT_NEED_FLY
	const EVENT_NEED_SURF
	const EVENT_NEED_STRENGTH
	const EVENT_NEED_ROCK_SMASH
	const EVENT_NEED_WHIRLPOOL
	const EVENT_NEED_WATERFALL
	const EVENT_NEED_FLASH
	const EVENT_12A
	const EVENT_12B
	const EVENT_12C
	const EVENT_12D
